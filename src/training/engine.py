...
def latih_hingga_step(
    ...
    global_step menunjukkan jumlah optimizer update
    ...
    while (
        ...
        for (
            ...
            # Simpan scale sebelum optimizer update.
            #
            # Digunakan untuk mengetahui apakah optimizer
            # benar-benar melakukan update parameter.
            ...
            # ------------------------------------------------
            # Scheduler hanya berjalan ketika optimizer update
            # berhasil dilakukan.
            # ------------------------------------------------
